...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="WebFormClass" >
     ...
     <br />
            <div class="NameClass">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="TextBox1" type="text" name="Name" runat="server" Width="534px"></asp:TextBox>
            </div>
           <br /> 
        <div class="Profile">
            <asp:Label ID="Label3" runat="server" Text="Profile"></asp:Label>
             ...
             <asp:RadioButtonList ID="RadioButtonList2" runat="server" Width="512px" CellPadding="1" CellSpacing="1" Height="27px" RepeatDirection="Horizontal" RepeatLayout="Flow" style="margin-left: 50px">   
              ...
              <asp:ListItem><img src="../Assets/profile-images/Female1.png" alt="" class="ListItem" /></asp:ListItem>
                 ...
                 <asp:ListItem><img src="../Assets/profile-images/Male1.png" alt="" class="ListItem" /></asp:ListItem>
             </asp:RadioButtonList>
                 </div>
        <br />
    ...
    <div>
        ...
        <br />
        <br />
            <asp:Button ID="Button1" runat="server" class="btn btn-outline-secondary" Text="Cancel" Width="180px" Height="50px" />&emsp;&emsp;&emsp;&emsp;&ensp;
             <asp:Button ID="Button2" runat="server" class="btn btn-outline-secondary" Text="Submit" Width="180px" Height="50px" BackColor="#99CC00" />&emsp;
             <asp:Button ID="Button3" runat="server" class="btn btn-outline-secondary" Text="Reset" Width="180px" Height="50px" />
        </div>
